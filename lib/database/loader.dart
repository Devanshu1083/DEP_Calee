...
class Loader {
  ...
  static Future<bool> saveCourses(List<String> course_id) async {
    ...
    Map<String?, String> course2prof = {
      "CS304": "Dr. Sudeepta Mishra",
      "CS305": "Dr. Abhinandan SP",
      "CS306": "Dr. Anil Shukla",
      "HS301": "Dr. Amritesh"
    };
    ...
    for (int i = 0; i < course_id.length; i++) {
      ...
      for (int j = 0; j < 2; j++) {
        ...
        String host = course2prof[title].toString();
  ...
  static Future<void> loadMidSem(
    ...
    List<String> dateComponents = exams[0][0].split('-');
  ...
  static Future<void> loadEndSem(
    ...
    for (int i = 0; i < courses.length; i++) {
      if(courseToSlot[courses[i]].toString()=="L/P")return;
